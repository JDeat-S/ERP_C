...
public final class Usuarios extends javax.swing.JFrame {
    ...
    public Usuarios() {
        ...
        setIconImage(new ImageIcon(Usuarios.class.getClassLoader().getResource("Imagenes/Icono.png")).getImage());
    ...
    public Usuarios(Logica_usuarios usr, Logica_permisos LP) {
        initComponents();
        this.setLocationRelativeTo(null);
        this.usr = usr;
        this.LP = LP;
...
//Nombre de la tabla
    ...
    private void initComponents() {
        ...
        P8RH = new javax.swing.JCheckBox();
        P9RH = new javax.swing.JCheckBox();
        ...
        P8RH.setText("Boton modificar en Actualizar empleado.");
        P8RH.setEnabled(false);

        P9RH.setText("Crear usuarios en sistema");
        P9RH.setEnabled(false);
        ...
        jMenu9.add(EmpleadosT);

        Depositos1.setText("Depositos");

        jMenu10.setText("Quincenales");

        jMenuItem12.setText("Depositos C/ IMSS");
        ...
        jMenuItem22.setText("Depositos C/ IMSS");
        ...
        jMenuItem23.setText("Depositos S/ IMSS");
        ...
        Depositos1.add(jMenu11);

        jMenu9.add(Depositos1);

        jMenuItem32.setText("Usuarios");
        ...
        jMenuItem33.setText("Tehuantepec");
        jMenuItem33.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem33ActionPerformed(evt);
            }
        });
        Semanales.add(jMenuItem33);

        jMenuItem34.setText("PTE titla");
        jMenuItem34.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem34ActionPerformed(evt);
            }
        });
        Semanales.add(jMenuItem34);

        jMenuItem35.setText("Generar vale de efectivo");
        jMenuItem35.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem35ActionPerformed(evt);
            }
        });
        Semanales.add(jMenuItem35);

        jMenuItem36.setText("Generar padron");
        jMenuItem36.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem36ActionPerformed(evt);
            }
        });
        Semanales.add(jMenuItem36);
    ...
    private void AAADNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AAADNActionPerformed
        if (AAADN.isSelected() == true) {
            ...
            P8RH.setSelected(false);
            P9RH.setSelected(false);
            ...
            while (rs.next()) {
                switch (rs.getString("Ventana de acceso")) {
                    ...
                    case "1" -> {
                        ...
                        P8RH.setEnabled(true);
                        P9RH.setEnabled(true);
                        P1PEN.setEnabled(false);
                        P2PEN.setEnabled(false);
                        P3PEN.setEnabled(false);
                        P1PEN.setSelected(false);
    ...
    private void txtbtnpdumodMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtbtnpdumodMousePressed
        ...
        if (AAADRH.isSelected() == true) {
            ...
            if (P8RH.isSelected() == true) {
                P8 = 1;
            } else {
                P8 = 0;
            }
            if (P9RH.isSelected() == true) {
                P9 = 1;
            } else {
                P9 = 0;
            }
    ...
    private javax.swing.JCheckBox P8RH;
    private javax.swing.JCheckBox P9Nom;
    private javax.swing.JCheckBox P9RH;
