 ...
 * @author JDeat
 */
public final class DepositosQSan_4 extends javax.swing.JFrame {
    ...
    public DepositosQSan_4() {
        ...
        setIconImage(new ImageIcon(DepositosQSan_4.class.getClassLoader().getResource("Imagenes/Icono.png")).getImage());
    }
    
    public DepositosQSan_4(Logica_usuarios usr, Logica_permisos LP) {
        initComponents();
        this.usr = usr;
        this.LP = LP;
        FunMD();
        ...
        año.setCalendar(fecha_actual);
        setIconImage(new ImageIcon(DepositosQSan_4.class.getClassLoader().getResource("Imagenes/Icono.png")).getImage());
        setTitle("RH: Depositos imss Santander # Usuario: " + usr.getId_user() + " " + usr.getApellidop() + " " + usr.getApellidoM() + " " + usr.getNombre()
...
//ingresos
    ...
    private void Tnom8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tnom8MouseClicked
        try {
            ...
            Logger.getLogger(DepositosQSan_4.class
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DepositosQSan_4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        /* Create and display the form */
        java.awt.EventQueue.invokeLater(() -> {
            new DepositosQSan_4().setVisible(true);
        });
    }
