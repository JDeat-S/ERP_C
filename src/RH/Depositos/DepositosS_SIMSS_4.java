...
public final class DepositosS_SIMSS_4 extends javax.swing.JFrame {
    ...
    public void Modeposito() {
        String SQL = "UPDATE `rh.depositosem." + Zon.getSelectedItem().toString() + ".simss` SET `#Folio` = '" + Integer.parseInt(NFnom.getText()) + "',"
                ...
                + "`Observaciones` = '" + Obsdeposito.getText() + "' WHERE `rh.depositosem." + Zon.getSelectedItem().toString() + ".simss`.`#Folio` = '" + Integer.parseInt(NFnom.getText()) + "'";
        try {
    ...
    public void Agregardeposito() {
        String SQL = "INSERT INTO `rh.depositosem." + Zon.getSelectedItem().toString() + ".simss` (`#Folio`, `#Lista`,"
...
//Anchos
    ...
    private void initComponents() {
        ...
        Zon.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    ...
    private void ZonItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_ZonItemStateChanged
        if (Semana.getSelectedIndex() == 0) {
            String SQL = "SELECT `Apellido P`, `Apellido M`, `Nombre(s)`, `Servicio`, `Bono`, `Semana` FROM `nominasem.detallada." + Zon.getSelectedItem().toString() + ".simss`"
