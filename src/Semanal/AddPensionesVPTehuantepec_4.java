 ...
 * @author JDeat
 */
public final class AddPensionesVPTehuantepec_4 extends javax.swing.JFrame {
    ...
    public AddPensionesVPTehuantepec_4() {
        initComponents();
        ...
        setIconImage(new ImageIcon(AddPensionesVPTehuantepec_4.class.getClassLoader().getResource("Imagenes/Icono.png")).getImage());
    }

    public AddPensionesVPTehuantepec_4(Logica_usuarios usr, Logica_permisos LP) {
        initComponents();
        CVeh = new ButtonGroup();
        CVeh.add(cv1);
        CVeh.add(cv2);
    ...
    private void initComponents() {
        ...
        Est.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "tehuantepec" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPensionesVPTehuantepec_4.class
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AddPensionesVPTehuantepec_4().setVisible(true);
        });
    }
