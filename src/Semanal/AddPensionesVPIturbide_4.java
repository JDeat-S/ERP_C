 ...
 * @author JDeat
 */
public final class AddPensionesVPIturbide_4 extends javax.swing.JFrame {
    ...
    public AddPensionesVPIturbide_4() {
        initComponents();
        ...
        setIconImage(new ImageIcon(AddPensionesVPIturbide_4.class.getClassLoader().getResource("Imagenes/Icono.png")).getImage());

    }

    public AddPensionesVPIturbide_4(Logica_usuarios usr, Logica_permisos LP) {
        initComponents();
        CVeh = new ButtonGroup();
        CVeh.add(cv1);
        CVeh.add(cv2);
    ...
    private void initComponents() {
        ...
        Est.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "", "iturbide" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPensionesVPIturbide_4.class
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new AddPensionesVPIturbide_4().setVisible(true);
        });
    }
