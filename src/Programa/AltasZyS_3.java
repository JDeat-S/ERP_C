...
//Modificar Servicio
    public void modS() {
        ...
        try {
            ...
            pst.setString(3, idZona.getText());
            pst.setInt(4, id);
...
//Agregar Servicio
    public void AgregarS() {
        ...
        String SQL = "INSERT INTO `confort`.`servicio` (`idZona`, `Nombre Zona`, `Supervisor`, `Servicio`, `Horario`, `Abre`, `Cierra`, `Sabado`, `Domingo`) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);";
        ...
        try {
            ...
            pst.setString(5, Horario.getText() + OtroS + TED);
            pst.setString(6, Abre.getText() + OtroS + TED);
            pst.setString(7, Cierra.getText() + OtroS + TED);
            pst.setString(8, horarioS + OtroS + TED);
            pst.setString(9, horarioD + OtroS + TED);
...
//Nombre de la tabla
            ...
            modelo.addColumn("Num. de servicio");//1
...
//Anchos
            int[] anchos = {10, 10, 50, 150, 150, 30, 15, 15, 15, 15};
